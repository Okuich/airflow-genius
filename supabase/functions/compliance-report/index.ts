...
const RULE_LIBRARY: ComplianceRule[] = [
  ...
  { id: "ASHRAE-55-5.3.1a", authority: "ASHRAE", standardCode: "55 §5.3.1", description: "Operative temp lower bound", metric: "operativeTemperature", threshold: 19.5, operator: ">=", severity: "Medium" },
  { id: "ASHRAE-55-5.3.1b", authority: "ASHRAE", standardCode: "55 §5.3.1", description: "Operative temp upper bound", metric: "operativeTemperature", threshold: 27.5, operator: "<=", severity: "Medium" },
...
serve(async (req) => {
  ...
  try {
    ...
    // Try to fetch from simulation_results if it looks like a simulation ID
    ...
    // Build compliance report from simulation result config
    ...
    const report = {
      ...
      simulationResult: {
        ...
        pressureDrop: data.pressure_drop,
